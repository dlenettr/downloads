...
$module = array(
	'name'		=> "MWS Downloads v1.6.1",
	'desc'		=> "Sitenize yüklediğiniz dosyaların ayrı sayfada indirilmesini sağlayabilirsiniz",
	'id'		=> "download",
	'icon'		=> "download.png",
	'date'		=> "18.06.2018",
	'ifile'		=> "install_module.php",
	'link'		=> "http://dle.net.tr",
	'image'		=> "http://img.dle.net.tr/mws/downloads.png",
...
if ( $is_logged && $member_id['user_group'] == "1" ) {
	...
	if ($_REQUEST['action'] == "install") {
		...
		$mod->file( ROOT_DIR. "/install/xml/downloads15.xml" );
		$mod->close();
