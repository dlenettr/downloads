...
if ( $action == "save" ) {
	...
	$save_con['save_log'] = intval($save_con['save_log']);
	$save_con['show_log'] = intval($save_con['show_log']);
...
echoheader( "<i class=\"fa fa-download position-left\"></i> <span class=\"text-semibold\">Downloads</span>", ['?mod=download' => 'Downloads'] );
...
HTML;
	...
	showRow( $lang['dwn_50'], $lang['dwn_51'], makeDropDown( [
			"0"  => $lang['dwn_52'],
			"1"  => $lang['dwn_53']
		], "save_con[save_log]", "{$dset['save_log']}"
	) );
	showRow( $lang['dwn_54'], $lang['dwn_55'], makeCheckBox( "save_con[show_log]", "{$dset['show_log']}" ) );

	showRow( $lang['dwn_24'], $lang['dwn_25'], makeCheckBox( "save_con[dis_index]", "{$dset['dis_index']}" ) );
	showRow( $lang['dwn_26'], $lang['dwn_27'], makeCheckBox( "save_con[use_timer]", "{$dset['use_timer']}" ), false );
